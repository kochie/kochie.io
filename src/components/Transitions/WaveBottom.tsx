...
import { createGradient } from "./linear-gradient";

export default function WaveBottom() {
  const [theme] = useTheme()

  const colours = createGradient(
    theme === THEME.dark ? "#475569" : "#ffffff", 
    theme === THEME.dark ? "#1f2937": "#e5e7eb", 
    5
  )
    ...
    <div>
      ...
      >
        <path
          ...
          // fill={colours[0]}
          className="dark:fill-[#475569] fill-[#ffffff]"
        ></path>
        <path
          ...
          // fill={colours[1]}
          className="dark:fill-[#3d4a5d] fill-[#f9f9fa]"
        ></path>
        <path
          ...
          // fill={colours[2]}
          className="dark:fill-[#333f50] fill-[#f2f3f5]"
        ></path>
        <path
          ...
          // fill={colours[3]}
          className="dark:fill-[#293444] fill-[#ecedf0]"
        ></path>
        <path
          ...
          // fill={colours[4]}
          className="dark:fill-[#1f2937] fill-[#e5e7eb]"
        ></path>
      </svg>
    </div>
  );
