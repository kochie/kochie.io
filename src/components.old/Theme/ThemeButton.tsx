...
const ThemeButton = () => {
  ...
  return (
    <div className="fixed top-0 right-0 z-50">
      <div className="pr-5 pt-5 pl-10 pb-10 animate duration-300 group flex-col flex gap-4 items-center text-white dark:text-black drop-shadow-2xl">
        ...
        <div className="cursor-pointer transition transform-gpu duration-300 animate scale-0 group-hover:scale-100 ease-in-out delay-200 group-hover:delay-0">
          ...
          >
            <FontAwesomeIcon
              icon={faCircle}
              className="fa-stack-2x dark:text-white text-black drop-shadow-2xl"
            />
            <FontAwesomeIcon icon={faLightbulbSlash} className="fa-stack-1x" />
          </div>
        </div>
